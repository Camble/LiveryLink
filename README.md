...
[![Download][download]](https://github.com/Camble/LiveryLink/releases/download/v0.9.3/LiveryLink.v0.9.3.+.Runtime.zip)
...
- Fixed JsonException when receiving multiple shared liveries
